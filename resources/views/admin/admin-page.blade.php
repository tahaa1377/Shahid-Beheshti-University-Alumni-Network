        ...
        <div class="header-wrapper">
            ...
            <div class="nav-container">
                ...
                <div class="nav">
                    ...
                    <div class="nav-left">
                        <ul>
                            <li><a href="/createNewJob"><i class="fa fa-bell" aria-hidden="true"></i> اخبار جدید</a></li>
                            <li id="messagei">
                            ...
                            <li><a href="/reportAmoozesh"><i class="fa fa-sticky-note" aria-hidden="true"></i>گزارش های آموزش</a></li>
                        </ul>
                    </div><!-- nav left ends-->
                        ...
                        <div class="in-center-wrap">
                            ...
                            <div class="tweet-wrap">
                                <div class="tweet-inner">
                                    ...
                                    <form method="post" action="/tweetPostadmin" enctype="multipart/form-data">
                                        @csrf
...
@section("js")
    ...
    <script src="/js/searchAdmin.min.js?o"></script>
